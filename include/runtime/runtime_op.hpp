#ifndef NET_INFER_INCLUDE_PARSER_RUNTIME_OPERATOR_HPP_
#define NET_INFER_INCLUDE_PARSER_RUNTIME_OPERATOR_HPP_
...
#endif  // NET_INFER_INCLUDE_PARSER_RUNTIME_OPERATOR_HPP_
