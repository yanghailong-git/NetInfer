...
int main(int argc, char* argv[]) {
  ...
  const std::string& param_path = "/workspace/neural_infer/NetInfer/models/resnet/resnet18_batch1.pnnx.param";
  const std::string& weight_path = "/workspace/neural_infer/NetInfer/models/resnet/resnet18_batch1.pnnx.bin";
